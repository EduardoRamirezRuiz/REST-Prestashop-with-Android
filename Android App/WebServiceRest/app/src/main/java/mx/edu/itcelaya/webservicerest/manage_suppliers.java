...
public class manage_suppliers extends AppCompatActivity {
    private static final String SERVICE_URL = "http://tpawluuaronnt2.one/prestashop/prestashop/api/suppliers" ;
        ...
        if (_actual_task == WebServiceTask.GET_TASK) {
            ...
            try {
                if(!response.equalsIgnoreCase("[]")) {
                    ...
                    JSONArray jsonMainNode = jso.optJSONArray("suppliers");
    ...
    private void hideKeyboard() {
        ...
        InputMethodManager inputManager = (InputMethodManager) manage_suppliers.this
                .getSystemService(Context.INPUT_METHOD_SERVICE);

        inputManager.hideSoftInputFromWindow(
                manage_suppliers.this.getCurrentFocus()
    ...
    private class WebServiceTask extends AsyncTask<String, Integer, String> {
        ...
        public String generaXMLCliente(Boolean nuevo, Integer id, String name, String desc, String link) {
            String format = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                    ...
                    "<name>%s</name>\n" +
                    "<active>1</active>\n" +
                    "<date_add>2015-11-09 11:34:05</date_add>\n" +
                    "<date_upd>2015-11-09 11:34:05</date_upd>\n" +
                    "<description><language id=\"1\" xlink:href=\"http://tpawluuaronnt2.one/prestashop/prestashop/api/languages/1\">" +
                    "%s</language></description>\n" +
                    "<meta_title><language id=\"1\" xlink:href=\"http://tpawluuaronnt2.one/prestashop/prestashop/api/languages/1\"></language></meta_title>\n" +
                    "<meta_description><language id=\"1\" xlink:href=\"http://tpawluuaronnt2.one/prestashop/prestashop/api/languages/1\"></language></meta_description>\n" +
                    "<meta_keywords><language id=\"1\" xlink:href=\"http://tpawluuaronnt2.one/prestashop/prestashop/api/languages/1\">%s</language></meta_keywords>\n" +
                    "</supplier>\n" +
                    "</prestashop>";
